      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {items.length === 0 ? (
          <div className="text-center py-16">
            ...
            <Link to="/shop" className="gradient-accent px-6 py-2.5 rounded-lg font-medium text-secondary-foreground inline-block" data-testid="link-browse-products">Browse Products</Link>
          </div>
        ) : (
