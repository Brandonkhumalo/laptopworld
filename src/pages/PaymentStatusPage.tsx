    ...
    if (!order) {
      return (
        <div className="text-center py-12">
          ...
          <Link to="/" className="gradient-accent px-6 py-2.5 rounded-lg font-medium text-secondary-foreground inline-block" data-testid="link-go-home">Go Home</Link>
        </div>
      );
    }
    ...
    if (order.status === 'cancelled') {
      return (
        <div className="text-center">
          ...
          <Link to="/cart" className="gradient-accent px-6 py-2.5 rounded-lg font-medium text-secondary-foreground inline-block" data-testid="link-try-again">Try Again</Link>
        </div>
      );
    }
