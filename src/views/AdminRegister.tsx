    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <img src={logoImg} alt="Laptop World" className="h-16 mx-auto mb-4" />
          <h1 className="font-display text-2xl font-bold text-foreground">Create Admin Account</h1>
          <p className="text-muted-foreground text-sm mt-1">Register to manage your store</p>
        </div>

        <form onSubmit={handleSubmit} className="rounded-xl bg-card border border-border p-6 shadow-product space-y-4">
          {error && (
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <a href="/admin/" className="text-accent hover:underline font-medium">
              Sign in
            </a>
          </p>
        </form>
