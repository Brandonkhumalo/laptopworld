      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <Link href="/" className="gradient-accent px-6 py-2.5 rounded-lg font-medium text-secondary-foreground inline-block" data-testid="link-browse">Browse Products</Link>
          </div>
        ) : (
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            {products.map((p, i) => (
